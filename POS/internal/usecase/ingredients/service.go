...
import (
	...
	dto "github.com/AXONcompany/POS/internal/http/ingredient"
...
func (s *IngredientService) UpdateIngredient(ctxt context.Context, id int64, updates dto.IngredientUpdates) (*ingredient.Ingredient, error) {
	if id <= 0 {
		return nil, ingredient.ErrInvalidID
	}
